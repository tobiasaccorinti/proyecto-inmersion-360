...
export const institucionesService = {
  ...
  /** Experiencias recomendadas según el tipo de institución */
  async recomendaciones(token: string): Promise<import('../types').Experiencia[]> {
    return apiRequest<import('../types').Experiencia[]>('/instituciones/mia/recomendaciones', { token })
  },
