...
/**
 * RegisterPage — Página de registro con panel decorativo y formulario de 2 pasos.
 * Ruta: /auth/register
 */
...
export default function RegisterPage() {
  return (
    <div className="min-h-screen flex" style={{ fontFamily: 'var(--font-body, sans-serif)' }}>
      ...
      <div className="hidden lg:flex w-1/2 bg-indigo-600 flex-col justify-between p-12">
        ...
        <div>
          ...
          <p className="text-indigo-200 text-lg leading-relaxed">
            Conectamos estudiantes secundarios con profesionales y empresas mediante
            experiencias reales elegidas por interés propio.
          </p>
        </div>
      ...
      <div className="flex-1 bg-[#EEEFFE] flex items-center justify-center p-8 overflow-y-auto">
        <RegisterForm />
      </div>
    </div>
  )
